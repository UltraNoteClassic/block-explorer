...
$ch = curl_init('https://superblockchain.con-ip.com/api/xun/json_rpc');
...
$ch2 = curl_init('https://superblockchain.con-ip.com/api/xun/json_rpc');
...
curl_setopt($ch3, CURLOPT_URL, 'https://superblockchain.con-ip.com/api/xun/getinfo');
